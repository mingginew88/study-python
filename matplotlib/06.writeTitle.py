...
# 한글 깨짐현상 제거를 위한 폰트 적용
path = './../font/NanumGothic.ttf'
font_prop = fm.FontProperties(fname=path, size=18).get_name()
plt.rc('font', family=font_prop)

# title 설정
# plt.title('matplotlib 스터디')

# font 설정
# fontweight : {'normal', 'bold', 'heavy', 'light', 'ultrabold', 'ultralight'} 중에서 선택 가능
title_font = {
    'fontsize': 10,
    'fontweight': 'bold'
}
...
# title 위치 지정
plt.title('matplotlib 스터디', fontdict=title_font, loc='right', pad=10)
